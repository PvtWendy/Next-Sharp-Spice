...
export default function Carousel(props) {
  ...
  switch (posts.length) {
    ...
    case 2:
      return (
        <article className={styles.slider}>
          <section className={styles.slide}style={{ transform: `translateX(0%)` }}>
            <a onClick={() => closeBtn(0)}>
              <img src={posts[0].image} alt="Red Kitchen" />
              <p>{posts[0].title}</p>
            </a>
          </section>
          <section className={styles.slide} style={{ transform: `translateX(100%)` }}>
    ...
    default:
      return (
        <article className={styles.slider}>
          ...
          <section className={styles.slide} style={{ transform: `translateX(200%)` }}>
